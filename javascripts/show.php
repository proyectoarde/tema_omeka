...
<script>
    ...
    $('#item-images').slick({
     ...
     $(".slick-slide a").each(function() {
         var urldoc = $('.slick-slide a').attr('href');
         if (this.href.indexOf('.pdf') != -1) {
             $(this).css("display","none");
             $(".slick-slide a").append('<embed src="' + urldoc + ' " width="100%" height="575" />');
         } 
         else if (this.href.indexOf('.mp4') != -1) {
      $(this).css("display","none");
      $(".slick-slide a").append('<div class="video"><video controls><source src="' + urldoc + '" type="video/mp4" /></video></div>');
  } 
